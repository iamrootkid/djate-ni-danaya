...
export const SalesStats = () => {
  ...
  const { data: stats } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data: todayInvoices, error: salesError } = await supabase
        .from("invoices")
        .select(`
          id,
          sales (
      ...
      const totalSales = todayInvoices.reduce((sum, invoice) => {
      ...
      const totalTransactions = todayInvoices.length;
